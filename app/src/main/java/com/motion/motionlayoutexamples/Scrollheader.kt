...
import kotlinx.android.synthetic.main.activity_scrollheader.*

class Scrollheader : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_scrollheader)
    ...
    private fun configureHeader() {
        ...
        val albumOfArtist="${getString(R.string.album_of)} ${getString(R.string.album_artist)}"
